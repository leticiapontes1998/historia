    <!DOCTYPE html>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body" id="carrinhoConteudo">
                                ...
                                <!-- Pode adicionar uma tabela, lista, ou qualquer conteúdo que desejar -->
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-dark" data-bs-dismiss="modal">Fechar</button>
                                <button type="button" class="btn btn-dark" onclick="finalizarCompra()">Continua Compra</button>
                            </div>
                        </div>
                    </div>
                </div> 
            ...
            <div id="carouselExampleFade" class="carousel slide carousel-fade">
                ...
                <div class="carousel-item active">
                    <img src="img/Box Azul Harry Potter (1).jpg" class="d-block w-20" alt="...">
                </div>
            ...
            <br>
                ...
                <div class="container mt-4">
                    <h3 class="mb-4" style="text-align: center;">Livros em Destaque</h3>
                    <br>
                    ...
                    <div class="row">
                        <div class="col-md-3 mb-4">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Descrição do Livro 1.</p>
                                    <p class="card-text"><strong>Preço: R$ 29,99</strong></p>
                                    <button class="btn btn-outline-dark" onclick="adicionarAoCarrinho('A paciente silenciosa', 29.99)">
                        ...
                        <div class="col-md-3 mb-4">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Descrição do Livro 2.</p>
                        ...
                        <div class="col-md-3 mb-4">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Descrição do Livro 2.</p>
                                    <p class="card-text"><strong>Preço: R$ 180,00</strong></p></p>
                                    <button class="btn btn-outline-dark" onclick="adicionarAoCarrinho('Box Azul Harry Potter', 180.00)">
                                        Adicionar ao Carrinho
                                    </button>
                                </div>
                            </div>
                        ...
                        <div class="col-md-3 mb-4">
                            <div class="card">
                                <img src="img/Lady Killers  Assassinas em Séri.jpg" class="card-img-top img-fluid mx-auto" alt="Livro 2">
                                <div class="card-body">
                                    <h5 class="card-title">Nome do Livro 2</h5>
                                    <p class="card-text">Descrição do Livro 2.</p>
                                    <p class="card-text"><strong>Preço: R$ 29,99</strong></p></p>
                                    <button class="btn btn-outline-dark" onclick="adicionarAoCarrinho('Livro 2', 19.99)">
                                        Adicionar ao Carrinho
                                    </button>
                                </div>
                            </div>
                        ...
                        <div class="col-md-3 mb-4">
                            <div class="card">
                                <img src="img/Mentes Sombrias 2.png" class="card-img-top img-fluid mx-auto" alt="Livro 2">
                                <div class="card-body">
                                    <h5 class="card-title">Nome do Livro 2</h5>
                                    <p class="card-text">Descrição do Livro 2.</p>
                                    <p class="card-text"><strong>Preço: R$ 29,99</strong></p></p>
                        ...
                        <div class="col-md-3 mb-4">
                            <div class="card">
                                <img src="img/Personalidades Perigosas 1.png" class="card-img-top img-fluid mx-auto" alt="Livro 2">
                                <div class="card-body">
                                    <h5 class="card-title">Nome do Livro 2</h5>
                                    <p class="card-text">Descrição do Livro 2.</p>
                                    <p class="card-text"><strong>Preço: R$ 29,99</strong></p></p>
                        ...
                        <div class="col-md-3 mb-4">
                            <div class="card">
                                <img src="img/Serial Killers. Anatomia do Mal.png" class="card-img-top img-fluid mx-auto" alt="Livro 2">
                                <div class="card-body">
                                    <h5 class="card-title">Nome do Livro 2</h5>
                                    <p class="card-text">Descrição do Livro 2.</p>
                                    <p class="card-text"><strong>Preço: R$ 29,99</strong></p></p>
                        ...
                        <div class="col-md-3 mb-4">
                            <div class="card">
                                <img src="img/Textos para tocar cicatrizes 1.jpg" class="card-img-top img-fluid mx-auto" alt="Livro 2">
                                <div class="card-body">
                                    <h5 class="card-title">Nome do Livro 2</h5>
                                    <p class="card-text">Descrição do Livro 2.</p>
                                    <p class="card-text"><strong>Preço: R$ 29,99</strong></p></p>
            ...
            <script>
                ...
                function adicionarAoCarrinho(nomeLivro, precoLivro) {
                    ...
                    // Redirecionando para o carrinho após clicar em "OK"
                    window.location.href = '#cartModal';
                ...
                function atualizarConteudoCarrinho() {
                    ...
                    if (carrinho.length === 0) {
                        carrinhoConteudo.innerHTML = '<p>Carrinho vazio.</p>';
                    } else {
                        // Criando uma tabela simples para exibir os itens do carrinho
                        ...
                        const colunaNome = linhaCabecalho.insertCell(0);
                        const colunaPreco = linhaCabecalho.insertCell(1);
                        const colunaQuantidade = linhaCabecalho.insertCell(2);
                        colunaNome.textContent = 'Nome do Livro';
                        ...
                        // Adicionando a linha do total
                        const linhaTotal = corpoTabela.insertRow();
                        const colunaTotalLabel = linhaTotal.insertCell(0);
                        const colunaTotalValor = linhaTotal.insertCell(1);
                        const colunaTotalQuantidade = linhaTotal.insertCell(2);
                        colunaTotalLabel.textContent = 'Total da Compra';
                        colunaTotalValor.textContent = `R$ ${calcularTotal().toFixed(2)}`;
                        colunaTotalQuantidade.textContent = '';
                ...
                function finalizarCompra() {
                    ...
                    window.location.href = 'http://localhost/Historia%20-%20Copia/Historia/Checkout.php';
                }
            </script>
                        ...
                        <footer class="py-5">
                            <div class="row">
                                ...
                                <div class="col-md-5 offset-md-1 mb-3">
                                    <form>
                                        <h5>
                                        Cadastre-se e receba nossas ofertas.</h5>
